 ...
 *
 * Writes src/resources/<singular>.ts with every blank marked TODO, and adds the import and
 * registration lines to src/resources/index.ts. The result does NOT pass
